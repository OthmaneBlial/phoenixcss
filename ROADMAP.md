...
- [ ] **Suivi :** trois pages exécutables ajoutées au site assemblé : guide avec bascule réelle du CSS, formulaire slate avec validation locale et landing page responsive. Rendu et interactions contrôlés dans Chrome, landing page également vue dans Safari et à fort zoom. Treize captures non modifiées issues de trois runs Chromium CI sont versionnées avec [provenance](assets/screenshots/README.md), dont cinq largeurs de landing relues. Elles devront être revues ou reprises sur le tag final ; lecteur d'écran et matrice manuelle restent à faire.
...
- [ ] **Suivi :** rendu réel inspecté avec Safari 26.6 et Chrome 153 sur macOS 26.6 ; largeurs exactes 320 à 1440 px mesurées dans Chrome et fort zoom inspecté dans Safari. Les 24 tests Playwright ont réussi sur Ubuntu 24.04.5 LTS avec Chromium 153, Firefox 155 et WebKit 26.6 pour le commit [`694d523`](https://github.com/OthmaneBlial/phoenixcss/actions/runs/35447229930), incluant offsets, mouvement réduit, cohabitation avec un site hôte et axe-core sans violation WCAG A/AA détectée sur huit états. Un [rapport daté](docs/VALIDATION.md) et treize captures réelles séparent ces observations des limites. Lecteur d'écran, zoom exact à 200 %, contrôle manuel du mouvement réduit et matrice complète restent à faire.
