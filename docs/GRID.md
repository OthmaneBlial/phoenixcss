...
These rules are compiled and covered by the [browser journeys](../tests/browser/journeys.spec.mjs) in Chromium, Firefox, and WebKit CI. The tests cover all eleven offsets, display utilities immediately before and at each breakpoint, and the real landing page at 320, 600, 768, 992, and 1200 px. The five [full-page captures](../assets/screenshots/README.md) were inspected after the [successful run for `694d523`](https://github.com/OthmaneBlial/phoenixcss/actions/runs/35447229930); the cards stack below 600 px without document overflow. Assistive-technology behavior remains in the manual review in task 4.2 of [ROADMAP.md](../ROADMAP.md).
